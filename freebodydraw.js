...
FreeBodyDraw.prototype.template = _.template([
    ...
    '               <label>type: </label>',
    '               <select id="type">',
    '                   <option disabled selected>Select type of force</option>',
    ...
    '               <label>on: </label>',
    '               <select id="on">',
    '                   <option disabled selected>force acting on...</option>',
    ...
    '               <label>from: </label>',
    '               <select id="from">',
    '                   <option disabled selected>...from interaction with</option>',
